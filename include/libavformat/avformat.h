...
#define AVINDEX_DISCARD_FRAME  0x0002    /**
                                          ...
                                          */
    int flags:2;
    int size:30; //Yeah, trying to keep the size of this small to reduce memory requirements (it is 24 vs. 32 bytes due to possible 8-unsigned char alignment).
...
#define AVFMT_AVOID_NEG_TS_MAKE_ZERO         2 ///< Shift timestamps so that they start at 0
     ...
     * is repositioned, for example when doing unsigned char based seeking.
 ...
 * discontinuities in the unsigned char stream. Generally works only with formats that
 ...
 * video or PCM data and will not serialize it into a unsigned char stream.
 *
