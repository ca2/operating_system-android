...
namespace multimedia
{
   ...
   namespace audio_aaudio
   {
      ...
      void wave_in::in_open(int32_t iBufferCount, int32_t iBufferSampleCount)
      {
         ...
         if(m_pstream != NULL && m_einstate != ::wave::e_in_state_initial)
         {
         ...
         if(mmr !=success)
         {
            ...
            {
               informationf("Attempted to open with an unsupported waveform-audio_aaudio format.");
            }
...
//         if((estatus = translate_aaudio(snd_pcm_start(m_pstream))) != success)
//         {
//
...
//         {
//
//            if(success != (estatus = translate_aaudio(snd_pcm_drain(m_pstream))))
//            {
//
...
//               {
//
//                  if ((err = snd_pcm_readi (m_pstream, in_get_buffer()->get_buffer_data(iBuffer), in_get_buffer()->m_uiBufferSize)) == in_get_buffer()->m_uiBufferSize)
//                  {
//                     in_proc(m_pstream, 0, 0, iBuffer, 0);
//                  }
//                  else
//                  {
...
//            ::e_status estatus;
//
//            if(!(estatus = translate_aaudio(snd_pcm_drop(m_pstream))))
//            {
//
...
/*      LPWAVEHDR wave_in::wave_hdr(int iBuffer)
      {
         return ::multimedia::audio_aaudio::get_os_data(in_get_buffer(), iBuffer);
      }*/
