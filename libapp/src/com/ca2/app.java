...
//			imm.hideSoftInputFromWindow (getWindowToken(), InputMethodManager.HIDE_IMPLICIT_ONLY);
		...
		if(m_result.m_iShowMessageBox > 0)
		{

			m_result.m_iShowMessageBox = 0;

			message_box(m_result.m_strMessageBox, m_result.m_strMessageBoxCaption, m_result.m_iMessageBoxButton);
...
//  }
    ...
    public void message_box(View view, String strMessage, String strCaption, int iButton)
	{

        AlertDialog.Builder builder = new AlertDialog.Builder(m_papp);

        builder.setTitle(strCaption);

        builder.setMessage(strMessage);

		m_result.m_iMessageBoxResult = 0;

		if(iButton & 1 || iButton == 0)
		{
			...
			builder.setPositiveButton("OK", new DialogInterface.OnClickListener()
			{
				...
				public void onClick(DialogInterface dialog, int which) 
				{
					...
					m_result.m_iMessageBoxResult = 1;
		...
		if(iButton & 2)
		{
			...
			builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener()
			{
				...
				public void onClick(DialogInterface dialog, int which) 
				{
					...
					m_result.m_iMessageBoxResult = 2;
		...
		if(iButton & 4)
		{
			...
			builder.setPositiveButton("Yes", new DialogInterface.OnClickListener()
			{
				...
				public void onClick(DialogInterface dialog, int which) 
				{
					...
					m_result.m_iMessageBoxResult = 4;
		...
		if(iButton & 8)
		{
			...
			builder.setNegativeButton("No", new DialogInterface.OnClickListener()
			{
				...
				public void onClick(DialogInterface dialog, int which) 
				{
					...
					m_result.m_iMessageBoxResult = 8;
