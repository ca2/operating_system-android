...
extern "C"
JNIEXPORT void JNICALL Java_platform_platform_main_1activity_aura_1init(JNIEnv * penv, jobject obj, jobject jobjectBind, jobject jobjectAssetManager)
{
   ...
   try
   {
      ...
      ::jni_bind::set(___new jni_bind(jobjectBind));
