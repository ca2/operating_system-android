...
namespace multimedia
{
   ...
   namespace audio_opensles
   {
      ...
      *///int32_t out::exit_thread()
      ...
      //void out::out_open(::thread* pthreadCallback, unsigned int uiSamplesPerSec, unsigned int uiChannelCount, unsigned int uiBitsPerSample, ::wave::enum_purpose epurpose)
      //{
