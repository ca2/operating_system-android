    ...
    namespace acme
    {
        ...
        namespace windowing
        {
            ...
            void window::create_window()
            {
               ...
               //m_pacmeuserinteraction->m_bMessageWindow = false;

               auto pwindowing = android_windowing();

               auto pacmedisplay = pwindowing->acme_display();

               //auto pdisplayx11 = dynamic_cast <::windowing_android::display *> (pwindowingdisplay);
               ...
               //int x = m_pacmeuserinteraction->const_layout().sketch().origin().x();

               //int y = m_pacmeuserinteraction->const_layout().sketch().origin().y();

               //int cx = m_pacmeuserinteraction->const_layout().sketch().width();

               //int cy = m_pacmeuserinteraction->const_layout().sketch().height();
               ...
               //set_os_data(LAYERED_X11, (::windowing_android::window *)this);
...
//#endif
               ...
               //if (m_pacmeuserinteraction->m_ewindowflag & e_window_flag_dock_window)
               //{

               //   wm_dockwindow(true);

               //}
               //else if (m_pacmeuserinteraction->m_ewindowflag & e_window_flag_desktop_window)
               //{

               //   wm_desktopwindow(true);

               //}
               //else if (m_pacmeuserinteraction->layout().sketch().activation() & ::user::e_activation_on_center_of_screen)
               //{

               //   wm_centerwindow(true);

               //}
               //else if (m_pacmeuserinteraction->m_ewindowflag & e_window_flag_satellite_window
               //   || m_pacmeuserinteraction->m_bToolWindow)
               //{
               ...
               //   m_pacmeuserinteraction->layout().window().display() = e_display_none;
               ...
               //      if (is_docking_appearance(m_pacmeuserinteraction->layout().sketch().display()))
               //      {
...
//                        }
               ...
               if (bOk) {
                  ...
                  //auto lresult = m_pacmeuserinteraction->send_message(::user::e_message_create, 0, (lparam) &pusersystem->m_createstruct);

                  auto lresult = m_pacmeuserinteraction->send_message(::user::e_message_create, 0, 0);
...
//      }
//
//      auto pwindowx11NewParent = dynamic_cast <::windowing_android::window *> (pwindowNewParent);
//
...
#undef SET_WINDOW_POS_LOG
            ...
            //   ::user::interaction * pinteraction = m_pacmeuserinteraction;
...
////      //      {
////      //
////      //         if(!(m_pacmeuserinteraction->m_ewindowflag & e_window_flag_arbitrary_positioning))
////      //         {
////      //
...
////         }
////
////         //m_pacmeuserinteraction->ModifyStyle(0, WS_VISIBLE, 0);
////
////      }
////      //      else
////      //      {
////      //
////      //         //m_pacmeuserinteraction->ModifyStyle(WS_VISIBLE, 0, 0);
////      //
////      //      }
////
...
//
            ...
            //            auto puserinteraction = m_pacmeuserinteraction;
