...
void jni_object::set_uch(const char * pszField, byte b)
{
...
byte jni_object::get_uch(const char * pszField)
{
...
void jni_object::set_uch(jfieldID fid, byte b)
{
...
byte jni_object::get_uch(jfieldID fid)
{
