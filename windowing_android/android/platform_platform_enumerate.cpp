...
extern "C"
JNIEXPORT void JNICALL Java_platform_platform_enumerate_music_jniAnnounce(JNIEnv * env, jobject obj, jlong id, jstring display_name, jstring full_path, jstring mime_type, jstring title, jstring artist)
{
...
extern "C"
JNIEXPORT void JNICALL Java_platform_platform_enumerate_image_jniAnnounce(JNIEnv * env, jobject  obj, jlong  id, jstring display_name, jstring full_path, jstring mime_type, jstring title)
{
...
extern "C"
JNIEXPORT void JNICALL Java_platform_platform_enumerate_video_jniAnnounce(JNIEnv * env, jobject  obj, jlong  id, jstring display_name, jstring full_path, jstring mime_type, jstring title, jstring artist)
{
